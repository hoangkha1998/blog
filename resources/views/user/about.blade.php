     ...
     <div class="container">
          <div class="row">
               <div class="col-md-offset-1 col-md-4 col-xs-12 pull-right">
                    <img src="user/images/about-1-720x720.jpg" class="img-responsive img-circle" alt="">
               </div>
     ...
     <div class="container">
          <div class="row">
               <div class="col-md-4 col-xs-12">
                    <img src="user/images/about-2-720x720.jpg" class="img-responsive img-circle" alt="">
               </div>
